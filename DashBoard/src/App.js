...
function App() {
 ...
 let carouselPosition = 0;
  ...
  const moveToNextCarousel = () =>{
    ...
    /* kaç tane slide oldugunu hesaplıyoruz. Sonra ekran boyutuna göre kaç tane kard oldugunu heaplatıp totalCarouselden eksil
    -tiyoruz bunu yapmazsak ektradan boş ileri atacak */
    let maxPer = (totalCarousel - (wrapperWidth.clientWidth / slideWidth.clientWidth)) * slideWidth.clientWidth;
  ...
  const data = {
    ...
    menuClass,setMenuClass,
    menuOpen,setMenuOpen,
    billspayment,setBillspayment
  }
